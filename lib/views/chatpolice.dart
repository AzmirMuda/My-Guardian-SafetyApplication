...
class policeChatscreen extends StatefulWidget {
  ...
  policeChatscreen({Key? key, this.initialPicture}) : super(key: key);

  @override
  _policeChatscreentState createState() => _policeChatscreentState();
}

class _policeChatscreentState extends State<policeChatscreen> {
