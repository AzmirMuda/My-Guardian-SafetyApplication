...
void main() {
  runApp(MaterialApp(
    home: ChatScreenAmbulans(),
  ));
}

class ChatScreenAmbulans extends StatefulWidget {
  final XFile? initialPicture;

  ChatScreenAmbulans({Key? key, this.initialPicture}) : super(key: key);

  @override
  _ChatScreenAmbulansState createState() => _ChatScreenAmbulansState();
}

class _ChatScreenAmbulansState extends State<ChatScreenAmbulans> {
