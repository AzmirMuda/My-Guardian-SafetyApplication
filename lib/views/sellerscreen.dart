                              ...
                              child: Column(children: [
                                ...
                                Flexible(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        "${Config.SERVER}.SERVER}/assets/productimages/${productList[index]}.png",
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Text(
                                              "RM ${double.parse(productList[index].productName.toString()).toStringAsFixed(2)}"),
...
//check permission,get location,get address return false if any problem.
  ...
  void _deleteProduct(index) {
    try {
      http.post(Uri.parse("${Config.SERVER}.SERVER}/php/delete_product.php"),
          body: {
            "productid": productList[index].productName,
          }).then((response) {
