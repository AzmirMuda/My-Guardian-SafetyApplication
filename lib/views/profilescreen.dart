...
class _ProfileState extends State<ProfileScreen> {
  ...
  void _loginform() {
    Navigator.pop(context);
    Navigator.push(
        context, MaterialPageRoute(builder: (content) =>   LoginPage(user: widget.user,)));
  }
...
//check permission,get location,get address return false if any problem.
  ...
  void _loadProducts() {
    ...
    http
        .get(Uri.parse(
            "${Config.SERVER}homeStayRaya/php/localprofileproduct.php?userid=${widget.user.id}"))
        .then((response) {
  ...
  void _deleteProduct(index) {
    try {
      ...
      http.post(Uri.parse("${Config.SERVER}homeStayRaya/php/delete_product.php"), body: {
