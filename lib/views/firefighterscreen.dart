...
import 'chatfirefighter.dart';

void main() {
  runApp(MaterialApp(
    home: firefighterChatscreen(),
  ));
}

class firefighterChatscreen extends StatefulWidget {
  @override
  State<firefighterChatscreen> createState() => _firefighterChatscreenState();
}

class _firefighterChatscreenState extends State<firefighterChatscreen> {
  ...
  void _navigateToChatScreen(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) => FirefighterChat(),
    ));
  }
}
